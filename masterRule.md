# Roadie — Build Spec v4.7 (Production)
...
### Camera & composition (locked exterior front view)
**Decision 2026-06-10 (v4.7), replaces the back-seat POV:** a **single locked exterior camera, slightly elevated, ahead of the car looking back at its front**. The hero car (flattened Cicada) drives toward the viewer; both occupants are visible through the windshield; the destination world streams past the car and recedes to the horizon behind it. This is the same "portrait of the two of us" intent, externalized — the car-as-shared-vessel is always on screen, and co-presence (two figures, gestures, the firework above the car) reads at a glance. The camera does not move; the car gets the life (gentle bob/roll). Camera distance is aspect-aware: hero framing on desktop landscape, pulled back on narrow/portrait viewports. Rationale: the interior cockpit view fought the framing at every iteration and hid the car; the exterior view is calmer, more cinematic, and shows off the strongest asset.
